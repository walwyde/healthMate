...
function EditUserProfile({
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    editProfile(formData, history, user.condition.diabetic ? "diabetic" : "hypertensive");
  };
    ...
    return (
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group controlId="glucoseReadings">
          ...
          {formData.glucoseReadings.map((reading, index) => (
            <div key={index}>
              ...
              {index > 0 && (
                <Button
                  variant="danger"
                  onClick={() => handleRemoveItem(index, "glucoseReadings")}
                >
                  Remove
                </Button>
              )}
          ...
          <Button
            variant="primary"
            onClick={() => handleAddItem("glucoseReadings")}
          >
            Add Glucose Reading
          </Button>
        </Form.Group>
        ...
        <Form.Group controlId="insulinDose">
          ...
          {formData.insulinDose.map((dose, index) => (
            <div key={index}>
              ...
              {index > 0 && (
                <Button
                  variant="danger"
                  onClick={() => handleRemoveItem(index, "insulinDose")}
                >
                  Remove
                </Button>
              )}
          ...
          <Button
            variant="primary"
            onClick={() => handleAddItem("insulinDose")}
          >
            Add Insulin Dose
          </Button>
        </Form.Group>
